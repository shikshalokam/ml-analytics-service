...
ML_DISTINCT_CNT_PROJECTS_STATUS_SPEC = config.get("DRUID","ml_distinctCnt_projects_status_spec_agg")
ML_DISTINCT_CNT_PRGMLEVEL_PROJECTS_STATUS_SPEC = config.get("DRUID","ml_distinctCnt_prglevel_projects_status_spec_agg")
